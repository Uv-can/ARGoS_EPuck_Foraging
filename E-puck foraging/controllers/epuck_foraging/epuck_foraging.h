...
public:
    ...
    * <controllers><epuck_foraging_controller><parameters><diffusion>
    * section.
    */
    ...
    * file, under the
    * <controllers><epuck_foraging_controller><parameters><wheel_turning>
    * section.
    */
   ...
   struct SStateData {
      ...
      /* The number of exploration steps without finding food after which
         a epuck starts thinking about going back to the nest */
...
public:
    ...
    * file in the <controllers><epuck_foraging_controller> section.
    */
